...
<div style="    text-align: center;">
    <img src="${path}/static/img/xxd/drawmoneyFail.png" style="margin-top: 30%;width: 65%;"/>
</div>
<div style="    text-align: center;
    margin: 40px 0 40px 0;">
    <div style="    font-size: 0.9rem;
    color: #007aff;
    margin-bottom: 20px;" class="errorTitle">errorTitle</div>
    <div class="errorMsg">【失败原因】errorMsg</div>
</div>
<a href="#" class="button button-51 active" id="confirm">返回</a>
</body>
