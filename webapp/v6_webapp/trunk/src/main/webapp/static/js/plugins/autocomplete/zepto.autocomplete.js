...
//        searchTextField.bind("keyup", $.proxy(this._handleLocalSearch, _this));
        searchTextField.bind("focus", $.proxy(this._locolFocus, _this));
    },
    ...
    _locolFocus: function () {
        var time = setInterval($.proxy(this._handleLocalSearch, this), 400);  
        var searchTextField = $('.autocomplete-input');
        searchTextField.bind('blur',function(){  
            clearInterval(time);  
        });  
    },
