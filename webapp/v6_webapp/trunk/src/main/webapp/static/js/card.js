...
define(function () {
    ...
    var cardUtil = {
        isCardValidate: function (card) {
            return cardUtil.isCardNo(card) && cardUtil.checkProvince(card) && cardUtil.checkBirthday(card) && cardUtil.checkParity(card);
        },
        /**
         * 检查号码是否符合规范，包括长度，类型
         * @param card
        ...
        checkBirthday: function (card) {
            ...
            if (len == '15') {
                ...
                return cardUtil.verifyBirthday('19' + year, month, day, birthday);
            }
            ...
            if (len == '18') {
                ...
                return cardUtil.verifyBirthday(year, month, day, birthday);
            }
            return false;
        },
        /**
        ...
        checkParity: function (card) {
            // 15位转18位
            card = cardUtil.changeFivteenToEighteen(card);
            var len = card.length;
            if (len == '18') {
         ...
         * @returns {string}
         */
        bankpvalue: function (bankCode, payBankDic) {
            var pvalue = '';
