define(['chart', 'chartDoughnut','js/utils/date','js/plan/planDetailsV2View','js/plan/planUtils','js/common/ami'], function (Chart, Doughnut, DateHandle,planDetailsV2View,PlanUtils,ami) {
	var financeInterval;
	var planId = "";
    ...
    var planDetailsV2Ctrl = {
        ...
        bindingEvents:function(){
            var bindings = [
                ...
                {
	                 element: '.goBack_memberDay',
	                 event: 'click',
	                 handler: planDetailsV2Ctrl.goBack_memberDay
                },
                {
                    element: '#goTender',
                    event: 'click',
        ...
        //返回
        goBack_memberDay:function(){
//        	mainView.router.back({url:"activity/memberDayWebapp.html"});
        	GS.loadPage("activity/memberDayWebapp.html");
        },
