                            ...
                            if(data.guarantorList != undefined && data.guarantorList.resultCode == 0) {
                                ...
                                if(guarantorArray.length > 0) {
                                    ...
                                    for(var i in guarantorArray) {
                                        ...
                                        html += '<p class="text-indent">1、借款人 '+data.rn.realName+'（身份证号：'+idNo+'） 通过_（上海）金融信息服务有限公司网站www.xinxindai.com（以下简称“_”）与全体投资人签订了编号为 '+data.billingbondCode+'的《借款合同》及相关法律文件（以下简称“主合同”）；</p>';
                                        ...
                                        html += '<p class="text-indent">1、本保证人具有签署及履行本保证函的全部法律授权和相应的民事行为能力；本保证人为法人的，为合法设立、有效存续之企业，并由股东以书面决议的形式同意对外担保本债务；如因本保证人未取得保证人法定身份或授权，导致投资人或_损失的，本保证人承诺赔偿受损方的全部损失。</p>';
                                        ...
                                        html += '<p class="text-indent">3、借款人任何一期的借款期限届满，但未能按照主合同约定偿付应付款项时，_作为互联网金融信息中介服务提供方，有权代表各投资人或相关债权的受让人直接向本保证人索偿，本保证人在收到_第一次出具的书面要求还款通知后七日内，即无条件按通知要求将保证人担保范围内的所有款项主动支付给_指定的银行账户，应支付额计算至保证人实际支付日。上述书面还款通知书对保证人具有法律约束力。</p>'
                                        html += '<p class="text-indent">4、如果保证人未能按前条规定期限履行上述担保责任，由此造成的逾期违约金和投资人、_网站的其它经济损失由保证人承担。保证人承诺：保证人就以上赔偿义务的履行无权提出异议和抗辩。</p>';
                                        html += '<p class="text-indent">5、本保证人及其他人共同对主合同下借款人的债务承担连带保证责任时，_有权代表投资人人或相关债权的受让人向本保证人主张全部债务的保证责任，本保证人无权提出异议和抗辩。</p>';
