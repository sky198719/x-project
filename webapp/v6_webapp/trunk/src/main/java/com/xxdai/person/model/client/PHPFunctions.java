...
import com.xxdai.core.util.cipher.EncodeUtil;
...
public abstract class PHPFunctions {
	...
	protected String urlencode(String value){
		try {
			...
			e.printStackTrace();
			System.out.println("字符转换异常-"+PHPFunctions.class.getName());
			return "";
		}
	}
	...
	protected String base64_decode(String input){
		try {
			return new String(EncodeUtil.base64Decode(input),"iso-8859-1");
		} catch (Exception e) {
			return e.getMessage();
		}
	}
	...
	protected String base64_encode(String input){
		try {
			return new String(EncodeUtil.base64Encode(input.getBytes("iso-8859-1")));
		} catch (Exception e) {
			return e.getMessage();
		}
	}
