...
public class Client extends PHPFunctions{
	...
	public static String UC_IP = "192.168.38.238";
	public static String UC_API = "http://192.168.38.238/bbs/uc_server";
	public static String UC_CONNECT = "";
	public static String UC_KEY = "v278jbs0E1J0l5C4Y4CeEf1ec6j91bfb11v9ffBc7bhcmcf2Da14l2m983feP8cc";
	...
	static {		
		UC_API = BBSConfiguration.get("UC_API");
		UC_IP = BBSConfiguration.get("UC_IP");
		UC_KEY = BBSConfiguration.get("UC_KEY");
		UC_APPID = BBSConfiguration.get("UC_APPID");
		UC_CONNECT = BBSConfiguration.get("UC_CONNECT");	
	}
