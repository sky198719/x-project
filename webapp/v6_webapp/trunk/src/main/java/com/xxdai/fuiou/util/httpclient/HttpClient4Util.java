package com.xxdai.fuiou.util.httpclient;
...
public class HttpClient4Util {
	 ...
	 * @param url
	 * @param httpParameter
	 *            参考{@link com.xxdai.fuiou.util.httpclient.HttpParameter}
	 * @param charset
	 *            参数编码
	 ...
	 * @param url
	 * @param httpParameter
	 *            参数信息 参考{@link com.xxdai.fuiou.util.httpclient.HttpParameter}
	 * @param charset
	 *            参数编码
	 * @return 参考{@link HttpResp}
	 * @throws org.apache.http.client.ClientProtocolException
