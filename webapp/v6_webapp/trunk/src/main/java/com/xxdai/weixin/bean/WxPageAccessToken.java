...
/**
 * 微信页面授权，AccessToken响应实体
 *
 * @author zhangyi
 */
public class WxPageAccessToken {
    /**
    ...
    public static WxPageAccessToken fromJson(String jsonStr) {
        JSONObject json = JSONObject.parseObject(jsonStr);
        WxPageAccessToken token = new WxPageAccessToken();
