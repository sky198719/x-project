require(['base', 'paging', "trackBase", 'store', 'side', 'juicer'
    ...
    var map = {
        ...
        incomePadingUrl: '/tradeCenter/fundUsertrade/RRYInvestmentDetail?type=1',
        incomePagination: $(".incomeTable-page"),
        inTableObject: $("#inTable"),
        inPadingUrl: '/tradeCenter/fundUsertrade/RRYInvestmentDetail?type=2',
        inPagination: $(".inTable-page"),
        outTableObject:$("#outTable"),
        outPadingUrl: '/tradeCenter/fundUsertrade/RRYInvestmentDetail?type=3',
