    ...
    */
    ...
    function investTable(tableData) {
        var title = '<tr class="title"><th>基本信息</th><th>历史年化收益</th><th>加入金额</th>'
            + '<th>历史收益</th><th>服务期</th><th>状态</th><th>到期时间</th><th>操作</th></tr>';
        var contentArray = [];
        var classColor;
    ...
    function outTable(tableData) {
        var title = '<tr class="title"><th>基本信息</th><th>历史年化收益</th><th>加入金额</th>'
            + '<th>实际收益</th><th>服务期</th><th>状态</th><th>到期时间</th><th>操作</th></tr>';
        var contentArray = [];
        var classColor;
        for (var i = 0, j = tableData.length; i < j; i++) {
            var row = tableData[i];
    ...
    var map = {
        ...
        investPadingUrl: '/tradeCenter/investBiz/myInvestmentProductsByToken/XYB',
        InvestPagination: $(".haveTable-page"),
        exitObject: $("#exitTable"),
        exitPadingUrl: '/tradeCenter/investBiz/myInvestmentProductsByToken/XYB',
