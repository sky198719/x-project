require(['base', "trackBase", 'store', 'side', 'juicer'
    ...
    if(document.domain == 'stage.xxd.com'){
        domain = 'http://stage-static.xxd.com/pc/1.5.0/build/mods/user/personalData/securitySettings/i/';
    }else if(document.domain == 'dev.xxd.com'){
        domain = 'http://dev-static.xxd.com/pc/1.5.0/build/mods/user/personalData/securitySettings/i/';
    }else if(document.domain == 'uat.xxd.com'){
        domain = 'http://uat-static.xxd.com/pc/1.5.0/build/mods/user/personalData/securitySettings/i/';
    }else if(document.domain == 'www.xinxindai.com'){
        domain = 'http://static.xinxindai.com/pc/1.5.0/build/mods/user/personalData/securitySettings/i/';
    }
