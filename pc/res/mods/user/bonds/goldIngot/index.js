require(['base', 'paging', "trackBase", 'store', 'side', 'juicer'
    ...
    */
    ...
    function XYBdetailTable(tableData) {
        var title = '<tr class="title"><th>序号</th><th>日期</th><th>加入金额</th>'
            + '<th>出借平台</th></tr>';
        var contentArray = [];
                ...
                $.xxdAjax({
                    ...
                    callbacks: function (data) {
                        ...
                        if ((data.code == "200000") || data.data) {
                            ...
                            investArray.push('<td>' + $.fnDateToString(data.interestEndTime, 'yyyy-MM-dd') + '</td>');
    ...
    var getXYBdetail = {
        ...
        XYBdetailPadingUrl: '/tradeCenter/optimizeScheme/investmentDetail/' + joinId,
