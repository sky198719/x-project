require(['base', 'float', 'trackBase', 'store', 'header', 'footer', 'requirejs', 'jqueryui', 'fullPage'], function ($, jqueryui, fullPage) {
    ...
    function init() {
        ...
        container1 = document.getElementsByClassName('space-container')[0];
        container2 = document.getElementsByClassName('space-container-top')[0];
        ...
        var material1 = new THREE.MeshBasicMaterial({
            map: new THREE.TextureLoader().load('img/space-blue.jpg')
        });

        var material2 = new THREE.MeshBasicMaterial({
            map: new THREE.TextureLoader().load('svg/space2.svg')
        });
