                            ...
                            <div className="active-detail">
                                <div className="invite-qualification">
                                    <ul>
                                        ...
                                        <li>
                                            ① 参与资格：邀请人（本人）须在新新贷有过出借记录，不满足资格的，不能参加本次活动。
                                        </li>
                                        <li>
                                            ② 适用平台：APP端（Android/iOS）
                                        </li>
                                        <li>
                                            ③ 适用产品（统计好友出借额的产品）：新元宝（包括所有期限及新手专享）、月月派及月进斗金；散标及债权转让除外
                                        </li>
                                        <li>
                        ...
                        {this.state.showDetail &&
                            <div className="warn">
                                <ul>
                                    ...
                                    <li>
                                        <span>② 若活动中发现存在作弊等不合规行为，新新贷有权取消该用户的奖励，并保留相关法律权利。</span>
                                    </li>
                                </ul>
                            </div>
                        }
                                    ...
                                    <div className="content">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <p> ● 需用户到新新贷App→我的新钱袋→我的奖励→我的新新币，自行兑换成现金。兑换无门槛。</p>
                            ...
                            <div className="page-4">
                                ...
                                <div className="page-4-box">
                                    ...
                                    <div className="content">
                                        <ul>
                                            <li>
                                                您邀请的<i>好友</i>在新新贷<i>注册成功</i>后，即可获得<i>108元</i>新人红包大礼
                                            </li>
                                            <li>
                                                <p> ● 108元共含4个红包，分别为5元、10元、25元、68元。</p>
                                                <p> ● 享受历史年化收益率{this.state.newUserRate}%的产品--新元宝（新手专享）的购买权。</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <img className="del-img" src={'../../static/mods/invite/imgs/delete.png'} onClick={this.closeReward.bind(this)}/>
