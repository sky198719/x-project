            ...
            <div>
                ...
                <div className="product-box position-a">
                    ...
                    <div className="product—detail-container position-a">
                        ...
                        <ul className="intro-list">
                            <Tab title="产品描述及加入说明" show={ true }>
                                <p>月进斗金是新新贷推出的<span className="notice">{productDetail.leastPeriod}{productDetail.leastPeriodUnit}</span>期出借计划，每日<span className="notice">10:00、20:00</span>限时销售，售完即止。</p>
                            ...
                            <Tab title="如何回款" show={ false }>
                                成功出借本产品之日起{productDetail.leastPeriod}{productDetail.leastPeriodUnit}（含加入当日及节假日）后，系统自动将本金加利息返回到您的新新贷账户。
                            </Tab>
                        </ul>
                    ...
                    <div className="div-bottom-btn">
                        <button className="xxd-xl-btn dmp-click" dev_id="A8.3-1.1" eventtype="jump" onClick={ this.openApp }>心动了吗？赶紧前往新新贷APP吧</button>
                    </div>
