            ...
            <div>
                ...
                <div className="hint-box position-a">
                    ...
                    <div className="hint-container position-a">
                        ...
                        <p>四、本人已认真阅读《_注册协议》、资金出借相关协议（《借款合同》、《债权转让协议》及_网站关于资金出借、资费介绍、标的说明等操作规则），充分了解在贵网站上出借资金的法律意义及相关风险，并根据自身的出借经验、出借目的、出借期限、自身资产状况等判断所选择的借款标的是否与自身的风险承受能力相当,避免因出借资金而遭受难以承受的损失。</p>
                        ...
                        <p>七、本承诺书自签订之日起单独成立并生效。本人通过_平台签订《借款合同》、《服务协议》等一切文书是否生效、无效或存在效力瑕疵，均不影响本承诺书的效力。</p>
