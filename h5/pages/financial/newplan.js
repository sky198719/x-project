            ...
            return (
                <div>
                    <Head>
                        ...
                        <title>__出借产品_多种期限出借服务-_</title>
                        <meta name="keywords" content="_，出借，出借服务，定期理财，投资理财" />
                        <meta name="description" content="_是_推出的自动投标计划，所有加入_的资金将由系统优先匹配优质债权，出借资金不站岗！详情请登录_官网。" />
                    </Head>
                    ...
                    <div className="product—detail-container position-a">
                        ...
                        <ul className="intro-list">
                            <Tab title="产品描述" show={ true }>
                                _是_推出的便捷高效的自动投标工具。_在用户认可的标的范围内，对符合要求的标的进行自动投标，且回款本金在相应期限内自动复投，期限结束后_会通过_债权转让平台进行转让退出。该计划对应标的由系统实现标的分散出借。
                            </Tab>
                           <Tab title="收益计算" show={ false }>
                            ...
                            <Tab title="回款方式" show={ false }>
                                <p>1、锁定期结束后次日（含周末及节假日）系统自动将本金和收益返回到_账户，不收取任何费用。</p>
