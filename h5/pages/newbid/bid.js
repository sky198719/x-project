            ...
            <div>
                ...
                <div className={ this.state.pops ? 'popup show' : 'popup' }>
                    ...
                    <div className="newbid-cont">
                        ...
                        <p className="indent-zero">新新贷用户名：{ userInfo.userName }</p>
                        <br />
                ...
                <div className={ this.state.autoPros ? 'popup show' : 'popup' }>
                    ...
                    <div className="newbid-cont">
                        ...
                        <p className="indent-zero">受托人：新新贷（上海）金融信息服务有限公司（以下简称新新贷）</p><br />
                        <p>鉴于委托人为在新新贷平台上实名注册的用户，现拟参与出借新新贷平台开发的自动配标工具（新元宝、月月派等），为优化委托人的用户体验，委托人就自动投标工具操作的相关事项向受托人做出如下授权：:</p>
                        <b>一、委托内容</b>
                        ...
                        <b>四、本委托书经委托人在新新贷平台以线上点击确认的方式签署。</b><br />
