        ...
        return (
            <div>
                ...
                <div className="new-container">
                    ...
                    <p className="new-tip">*仅限未曾在新新贷投资过的用户加入，每位用户限购1次</p>
                </div>
                        ...
                        <ul>
                            <li className={ this.state.shows == '1' ? 'show' : 'hide' }>
                                <div style={{ alignItems: 'center', justifyContent: 'center', background: '#fff', paddingTop: '15px' }}>
                                    <h2>投资介绍</h2>
                                    <p>新手标是<span className="red">针对尚未在新新贷投资过的新手用户</span>推出的自动投标理财计划，新手标在用户认可的标的范围内，对符合要求的标的进行自动投标，且回款本金在相应期限内自动复投，期限结束后新手标会通过新新贷债权转让平台进行转让退出。该计划一旦投标成功，不支持提前退出或债权转让。该计划所对应的标的由系统实现标的分散投资。</p>
                                    <h2>投资图示</h2>
                                    ...
                                    <h2>回款方式</h2>
                                    <p>锁定期结束后次日（含周末及节假日）系统自动将本金和收益返还到新新贷账户</p>
                                    <h2>费用说明</h2>
                            ...
                            <li className={ this.state.shows == '2' ? 'show' : 'hide' }>
                                <div style={{ alignItems: 'center', justifyContent: 'center', background: '#fff', paddingTop: '15px' }} className="tabs-pro">
                                    ...
                                    <p>不可以，新手红包仅限在投资步步高升、月月派、新元宝产品及散标直投产品（票据贷除外）可用。</p>
                                    <h2>3、投资新手标锁定期内可以退出吗？</h2>
                                    <p>不可以，新手标1个月和3个月，锁定期限内均不支持提前退出。</p>
                                    <h2>4、新手标安全吗？</h2>
                                    <p>新新贷以严谨负责的态度对每笔借款进行严格筛选。同时，交易资金由银行存管，杜绝挪用和隔离风险。</p>
                                </div>
                            </li>
                ...
                <div className={ this.state.pops ? 'popup show' : 'popup' }>
                    ...
                    <div className="static-class">
                        <h5>资金出借风险提示函</h5>
                        <p>出借人应认真阅读《新新贷网站服务协议》、资金出借相关协议（《借款合同》、《债权转让协议》等）、本函内容及本网站（www.xinxindai.com）关于资金出借、资费介绍、标的说明等操作规则，充分了解在本网站上出借资金的法律意义及相关风险，并根据自身的出借经验、出借目的、出借期限、自身资产状况等判断所选择的借款标的是否与自身的风险承受能力相当。 
                        ...
                        <h6>四、本人已认真阅读《新新贷注册协议》、资金出借相关协议（《借款合同》、《债权转让协议》及新新贷网站关于资金出借、资费介绍、标的说明等操作规则），充分了解在贵网站上出借资金的法律意义及相关风险，并根据自身的出借经验、出借目的、出借期限、自身资产状况等判断所选择的借款标的是否与自身的风险承受能力相当,避免因出借资金而遭受难以承受的损失。</h6>
                        ...
                        <h6>七、本承诺书自签订之日起单独成立并生效。本人通过新新贷平台签订《借款合同》、《服务协议》等一切文书是否生效、无效或存在效力瑕疵，均不影响本承诺书的效力。</h6>
                        <p>特此承诺！</p>
