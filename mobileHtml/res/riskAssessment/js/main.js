require(['base', 'requirejs', 'trackBase', 'json', 'Swiper'], function ($, requirejs, track) {
    ...
    var riskResult = {
        level1: {
            totalScore: '25分以下',
            typeName  : '风险厌恶型',
            notes     : '亲，您的金融投资风险偏好或承受能力很低，不建议以P2P为主要投资理财渠道。您可购买余额宝类货币基金，如果对P2P感兴趣，可以参加_的“新新宝体验计划”。（本测试仅适用于个人，结果供参考）'
        },
        level2: {
            totalScore: '25—49',
            typeName  : '低风险偏好型',
            notes     : '亲，您的金融投资风险偏好或承受能力较低，可以投资P2P，建议在P2P领域的资产配置不要超过个人可支配收入20%。可以尝试在_做分散投资，如果每月在新做每月固定金额的定投效果会不错哦。（本测试仅适用于个人，结果供参考）'
        },
        level3: {
            totalScore: '50—69',
            typeName  : '中等风险偏好型',
            notes     : '亲，您的金融投资风险偏好或承受能力中等，能承受一定的风险，可以投资P2P，建议在P2P领域的投资不要超过个人可支配收入的40%，可以在_做投资，注意控制生活开支，以及自身资金的流动性哦。（本测试仅适用于个人，结果供参考）'
        },
        level4: {
            totalScore: '70—89',
            typeName  : '高风险偏好型',
            notes     : '亲，您的金融投资风险偏好或承受能力非常高，在P2P领域的投资可以占到个人可收入的60%。_建议您可以适当将资产配置到股市、期货等高风险高风险投资领域，_友情提醒：投资有风险，入市需谨慎。（本测试仅适用于个人，结果供参考）'
        },
        level5: {
            totalScore: '90以上',
            typeName  : '极端风险偏好型',
            notes     : '亲，您的金融投资风险偏好极高，普通P2P理财方式可能无法满足您的投资需求，可对股市、期货等高风险金融资产做配置，并可尝试比特币、众筹、私募股权基金、艺术品、贵金属等投资。_友情提示，投资有风险，入市需谨慎。（本测试仅适用于个人，结果供参考）'
        }
    };
    ...
    $(function () {
        ...
        //确认退出
        $(document).on('click', '#exit_confirm', function () {
            $.ajax({
                url:'/feapi/dmp/userinfo.html ',
                contentType: "application/json",
                dataType:"json",
                ...
                success:function (res){
                    try {
                        XXD_TRACK._trackEvent({
                            category: "webapp_riskAssessment",
                            action: "close_assessment",
                            label: "确认退出",
                            value:res.userId,
                            custval: ""
                        });
                        ga('send', 'event','风险承受能力评估', '确认退出', window.location.href);
                    } catch (e){
                    }
                }
            });
            ...
            $.ajax({
                ...
                success:function (res){
                    try {
                        XXD_TRACK._trackEvent({
                            category: "webapp_riskAssessment",
                            action: "goBack_webapp",
                            label: "返回",
                            value:res.userId,
                            custval: ""
                        });
                        ga('send', 'event','风险承受能力评估', '返回', window.location.href);
                    } catch (e){
                    }
                }
            });
            ...
            $.ajax({
                ...
                success:function (res){
                    try {
                        ...
                        ga('send', 'event','风险承受能力评估', '继续评测', window.location.href);
                    } catch (e){
                    }
                }
            });
