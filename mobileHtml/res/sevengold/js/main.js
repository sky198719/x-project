require(['jquery', "requirejs", 'IScroll', "trackBase", 'xui_user_v102', 'mcLayer_v100', 'com'], function ($, requirejs, IScroll, track, user, mcLayer, com) {
    ...
    var db = {
            ...
            com.ajax({
                ...
                success: function (r) {
                    if (r.code == "200000") {
                        ...
                        $(".sevenDayApr").html(r.data.productInfo.apr);
                        $("#sevenDayFloatApr").html(r.data.productInfo.floatApr);
                        $(".lowestTender").html(r.data.productInfo.lowestTender);
                        $("#mostTender").html(r.data.productInfo.mostTender);
                    }
                },
                error    : function () {
                    alert('网络异常请重试！');
        ...
        monthFinance: function () {
            $.ajax({
                ...
                success : function (r) {
                    if (r.code == 200000) {
                        $("#monthApr").html(r.data.items.apr);
                        $("#monthcloseTerm").html(r.data.items.period);
                        $("#monthMoney").html(r.data.items.lowestTender);
                    }
                }
            });
        },
    ...
    $(function () {
        ...
        $(document).on('click', '#monthBuy', function () {
            user.isLogin({
                success: function () {
